...
var activaCtrl = (function() {
  ...
  var operationName = "actualizar instancias";
  ...
  return {
    init: function() {
      ...
      jQuery("#div-activar #chkInstancias").click(function (){checkAll(".chkinstancias","#chkInstancias")});
      jQuery("#div-activar #chkNodes").click(function (){checkAll(".chknodes","#chkNodes")});
