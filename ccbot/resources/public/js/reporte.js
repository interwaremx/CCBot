  ...
  return {
    init: function() {
      ...
      $("#appForm").validate({
		...
		rules: {fechaInicio: {required: true},
			fechaTermino: {required: true}},
        messages: {fechaInicio: {required: "No se ha definido un valor para el campo fecha de Inicio."},
			fechaTermino: {required: "No se ha definido un valor para el campo fecha de Término."}
        }
      });
    }
  };
