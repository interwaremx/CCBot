...
var appCtrl = (function() {
  ...
  var operationNameSA = "guardar par\u00e1metros de aplicaci\u00f3n";
  var operationNameDA = "eliminar aplicaci\u00f3n";
  var NAPP = "Nueva...";
  var NV = "desconocido";
  var app = NV;
  var conf = {};
  ...
  var setParameters = function(tagId,data) {
    ...
    for (name in data) {
      if (data.hasOwnProperty(name)) {
		...
		'<td width=\"20%\"><input type=\"text\" maxlength=\"30\" value=\"'+name+'\" style=\"width: 97%;\" class=\"required field\"/></td>'+
		'<td width=\"75%\"><input type=\"text\" maxlength=\"100\" value=\"'+data[name]+'\" style=\"width: 97%;\"/ class=\"required field\"/></td>'+
		'</tr>');
  ...
  var addParameterInit = function() {
	...
	'<td width=\"75%\"><input type=\"text\"  maxlength=\"100\" style=\"width: 97%;\" class=\"required field\"/></td></tr>');
  ...
  var addInstanceInit = function() {
	...
	//'<td width=\"5%\"><input type="button" id='+uuid+' class="button" value="Borrar"/></td>'+
	'<td width=\"5%\" align=\"center\"><a id='+uuid+'><img src=\"/images/node/delete.png\"/></a></td>'+
	'<td width=\"20%\"><input name=\"'+instUUID+'\" type=\"text\"  maxlength=\"30\" style=\"width: 97%;\" class=\"instance required field\"/></td>'+
	'<td width=\"75%\"><table class=\"tableNodeField\"><tr>'+
	  ...
	  '</tr></table></td>'+
	  '</tr><tr>'+
	    '<td align=\"right\"><input type="button" id='+addUUID+' class="button" value="Agregar Parámetro"/></td>'+
	  '</tr></table></td>'+
	'</tr>');
    jQuery("#"+uuid).click(function () {
      $("#"+uuid).parent().parent().remove();
      ...
      if (conf.instances.hasOwnProperty(instName)) {
		...
		'<td width=\"20%\"><input class=\"instance required field\" style=\"width: 97%\" name=\"'+instUUID+'\" type=\"text\"  maxlength=\"30\" value=\"'+instName+'\"/></td>'+
		  '<td width=\"75%\"><table class=\"tableNodeField\"><tr>'+
		    ...
		    '</tr></table></td>'+
		  '</tr><tr>'+
		    '<td align=\"right\"><input type="button" onclick=\"appCtrl.onclickAdd(\''+instUUID+'\');\" id='+addUUID+' class="button" value="Agregar Parámetro"/></td>'+
		  '</tr></table></td>'+
		'</tr>');
