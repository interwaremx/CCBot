...
//Definición de literales por locale
/*
		CASTELLANO
*/
...
literales_arrayLiteralesCastellano['UTILS_NO_OPER_FUERA']="No se permite realizar la ejecución de una operación NACAR \ndesde fuera del navegador Embebido";
literales_arrayLiteralesCastellano['UTILS_ERROR_INSERTAR_CELDA']="Error al insertar celda datos para la edición en fila: \n\"";
...
literales_arrayLiteralesCastellano['UTSERV_NO_EJEC_OPER_COMU_PORTAL']="No se ha ejecutado la operación porque no se ha establecido comunicación con el Portal";
literales_arrayLiteralesCastellano['UTSERV_ERROR_AJAX']="Se ha producido el siguiente error: ";
literales_arrayLiteralesCastellano['UTSERV_NO_BAJADA_COMU_PORTAL']="No se ha realizado la bajada del objeto de negocio porque no se ha establecido comunicación con el Portal";
literales_arrayLiteralesCastellano['UTSERV_NO_SUBIDA_COMU_PORTAL']="No se han subido los datos al objeto de negocio porque no se ha establecido comunicación con el Portal";
literales_arrayLiteralesCastellano['UTSERV_NO_VENTANA_PORTAL']="No se ha recuperado la ventana del Portal";
literales_arrayLiteralesCastellano['UTSERV_NO_TAREA_COMU_PORTAL']="No se ha ejecutado la tarea porque no se ha establecido comunicación con el Portal";
literales_arrayLiteralesCastellano['UTSERV_NO_ACTIVAR_TAREA_COMU_PORTAL']="No se ha activado la tarea porque no se ha establecido comunicación con el Portal";
literales_arrayLiteralesCastellano['UTSERV_NO_DESTRUIR_TAREA']="No se ha destruido la tarea porque no se ha establecido comunicación con el Portal";
literales_arrayLiteralesCastellano['UTSERV_NO_DESTRUIR_TAREAS']="No se han destruido las tareas porque no se ha establecido comunicación con el Portal";
literales_arrayLiteralesCastellano['UTSERV_NO_MODIF_DESC_COMU_PORTAL']="No se ha modificado la descripción de la tarea porque no se ha establecido comunicación con el Portal";
literales_arrayLiteralesCastellano['UTSERV_NO_ID_TAREA_COMU_PORTAL']="No se ha obtenido el identificador de la tarea porque no se ha establecido comunicación con el Portal";
literales_arrayLiteralesCastellano['UTSERV_NO_OBTENC_TAREAS_ACTIVAS']="No se ha obtenido el número de tareas activas porque no se ha establecido comunicación con el Portal";
literales_arrayLiteralesCastellano['UTSERV_NO_ACT_ESCENARIO']="No se ha activado el escenario porque no se ha establecido comunicación con el Portal";
literales_arrayLiteralesCastellano['UTSERV_NO_REC_OBJNEG']="No se ha recuperado el objeto de negocio porque no se ha establecido comunicación con el Portal";
//Literales del fichero contenedores.js en Castellano
literales_arrayLiteralesCastellano['CONTE_VER_MAS']="Ver más";
...
literales_arrayLiteralesCastellano['DIGI_ERROR_ALIMENTADOR']="Se ha producido un error al tratar con el alimentador del escáner.";
literales_arrayLiteralesCastellano['DIGI_SELECCION_ESCANER']="No se ha podido seleccionar el escáner. Compruebe si está apagado.";
literales_arrayLiteralesCastellano['DIGI_NUM_PAG_SUPERIOR']="Se ha especificado un número superior de páginas a las que existen en el alimentador.";
literales_arrayLiteralesCastellano['DIGI_ESCANEO_CANCELADO']="Se ha cancelado el proceso de escaneo de la información.";
literales_arrayLiteralesCastellano['DIGI_FIN_DIGITALIZACION']="La digitalización ha concluido correctamente";
...
literales_arrayLiteralesCastellano['DIGI_FIN_DIGITALIZACION_2']="La digitalización ha concluido correctamente.";
...
literales_arrayLiteralesCastellano['DIGI_LECTURA_CHEQUE_BANDA_OK']="Proceso de lectura de cheque y banda magnética ejecutado correctamente.";
literales_arrayLiteralesCastellano['DIGI_LECTURA_CHEQUE_OK']="Proceso de lectura de cheques ejecutada correctamente.";
literales_arrayLiteralesCastellano['DIGI_LECTURA_BANDA_OK']="Proceso de lectura de banda magnética ejecutado correctamente.";
...
literales_arrayLiteralesCastellano['AJAX_OPER_NO_INFORMADA']="Operación no informada";
...
literales_arrayLiteralesCastellano['LITERAL_RANGO']="Rango páginas";
...
literales_arrayLiteralesCastellano['AJAX_ERROR_HTTP_OTROS']="La petición ha devuelto un código HTTP";
//literales del ev. cierre controlado de aspa
literales_arrayLiteralesCastellano['ASPA_VALOR_PARAM_NO_PERMITIDO']="Error: La función javascript 'activarCierreControladoAspa' sólo puede recibir los valores 'true' o 'false'";
...
literales_arrayLiteralesCastellano['ATPI_ANADIR_FAVORITO']="Se va a añadir un nuevo Favorito a la combo de Mis Accesos, ¿Desea realizar la operación?";
...
literales_arrayLiteralesCastellano['ATPI_RETORNO_FAVORITO_0']="El servicio de gestion de favoritos retorna el código {0} que corresponde a Inserción realizada correctamente.";
literales_arrayLiteralesCastellano['ATPI_RETORNO_FAVORITO_10']="El servicio de gestion de favoritos retorna el código {10} que corresponde a Los campos de entrada contienen caracteres inválidos ( # < > “ ‘ \ % )";
literales_arrayLiteralesCastellano['ATPI_RETORNO_FAVORITO_20']="El servicio de gestion de favoritos retorna el código {20} que corresponde a El campo COD_USURIO no está informado en la entrada";
literales_arrayLiteralesCastellano['ATPI_RETORNO_FAVORITO_21']="El servicio de gestion de favoritos retorna el código {21} que corresponde a El campo XTI_ORIGEN no está informado en la entrada";
literales_arrayLiteralesCastellano['ATPI_RETORNO_FAVORITO_30']="El servicio de gestion de favoritos retorna el código {30} que corresponde a Falta campos de entrada DES_OPESEGU_OPERACION";
literales_arrayLiteralesCastellano['ATPI_RETORNO_FAVORITO_40']="El servicio de gestion de favoritos retorna el código {40} que corresponde a COD_CARPKDAP  erróneo, no existe";
literales_arrayLiteralesCastellano['ATPI_RETORNO_FAVORITO_50']="El servicio de gestion de favoritos retorna el código {50} que corresponde a DES_OPESEGU_MENU erróneo, no existe";
literales_arrayLiteralesCastellano['ATPI_RETORNO_FAVORITO_60']="El servicio de gestion de favoritos retorna el código {60} que corresponde a DES_OPESEGU_OPERACION erróneo, no existe";
literales_arrayLiteralesCastellano['ATPI_RETORNO_FAVORITO_70']="El servicio de gestion de favoritos retorna el código {70} que corresponde a COD_USUARIO  supera la longitud máxima permitida";
literales_arrayLiteralesCastellano['ATPI_RETORNO_FAVORITO_71']="El servicio de gestion de favoritos retorna el código {71} que corresponde a DES_OPESEGU_OPERACION  supera la longitud máxima permitida";
literales_arrayLiteralesCastellano['ATPI_RETORNO_FAVORITO_72']="El servicio de gestion de favoritos retorna el código {72} que corresponde a DES_OPESEGU_MENU  supera la longitud máxima permitida";
literales_arrayLiteralesCastellano['ATPI_RETORNO_FAVORITO_73']="El servicio de gestion de favoritos retorna el código {73} que corresponde a XTI_ORIGEN  supera la longitud máxima permitida";
literales_arrayLiteralesCastellano['ATPI_RETORNO_FAVORITO_100']="El servicio de gestion de favoritos retorna el código {100} que corresponde a El registro ya existe en la base de datos";
literales_arrayLiteralesCastellano['ATPI_RETORNO_FAVORITO_200']="El servicio de gestion de favoritos retorna el código {200} que corresponde a No se ha podido realizar la inserción en la Base de Datos";
literales_arrayLiteralesCastellano['ATPI_RETORNO_FAVORITO_1']="La respuesta obtenida ante la petición de añadir favoritos es incorrecta. No se añadirá al conjunto de favoritos.";

//Literales del fichero atpiAreaAccesos.js en Castellano	
literales_arrayLiteralesCastellano['ATPI_MAX_FAVORITOS']="Se ha alcanzado el número máximo de favoritos. No se pueden añadir más favoritos.";
literales_arrayLiteralesCastellano['ATPI_RET_FAVORITOS_0']="El servicio de gestion de favoritos retorna el código {0} que corresponde a Consulta realizada correctamente";
literales_arrayLiteralesCastellano['ATPI_RET_FAVORITOS_10']= "El servicio de gestion de favoritos retorna el código {10} que corresponde a El campo COD_USURIO no está informado en la entrada";
literales_arrayLiteralesCastellano['ATPI_RET_FAVORITOS_11']= "El servicio de gestion de favoritos retorna el código {11} que corresponde a El campo XTI_ORIGEN no está informado en la entrada";
literales_arrayLiteralesCastellano['ATPI_RET_FAVORITOS_12']= "El servicio de gestion de favoritos retorna el código {12} que corresponde a El campo IDIOMA no está informado en la entrada";
literales_arrayLiteralesCastellano['ATPI_RET_FAVORITOS_200']= "El servicio de gestion de favoritos retorna el código {200} que corresponde a No se ha podido realizar la consulta en la Base de Datos";
literales_arrayLiteralesCastellano['ATPI_RET_FAVORITOS_300']= "El servicio de gestion de favoritos retorna el código {300} que corresponde a El usuario no tiene favoritos";
literales_arrayLiteralesCastellano['ATPI_RET_FAVORITOS_1']= "El servicio de gestion de favoritos retorna el código {300} que corresponde a El usuario no tiene favoritos";
...
literales_arrayLiteralesCastellano['ATPI_DIA_4']="miércoles";
literales_arrayLiteralesCastellano['ATPI_DIA_5']="jueves";
literales_arrayLiteralesCastellano['ATPI_DIA_6']="viernes";
literales_arrayLiteralesCastellano['ATPI_DIA_7']="sábado";
...
literales_arrayLiteralesCastellano['ATPI_PARAMS_ENVIADOS']="parámetros enviados es";
...
literales_arrayLiteralesCastellano['ATPI_MENSAJE_CIERRE_TAREA']="Para abrir una nueva tarea se cerrará la tarea número @NUMERO@ ( @TAREA@ ) , ¿está seguro?";
...
literales_arrayLiteralesCastellano['ATPI_ESCENARIO_ACTIVO']="El escenario que intenta seleccionar ya está activo.";
...
literales_arrayLiteralesCastellano['ATPI_NUEVA_DEP']="---------NUEVA DEPURACIÓN------------";

//Literales del fichero multiidioma.js en Castellano			
literales_arrayLiteralesCastellano['ATPI_CERRAR_IDIOMA']="Si cambia de idioma se cerrarán todas las tareas abiertas. ¿Seguro que desea cambiar el idioma?";
...
literales_arrayLiteralesCastellano['ATPI_OPERACION']="La operación requiere de un ";
literales_arrayLiteralesCastellano['ATPI_OPERACION_OBJ']="La operación requiere de objeto de negocio cliente, pero no está disponible en el escenario";
...
literales_arrayLiterales_en_gb['ATPI_RETORNO_FAVORITO_0']="The bookmark management service returns the code {0} que corresponde a Inserción realizada correctamente.";
...
//Literales del fichero AtpiCalendario.js en Catalán
literales_arrayLiteralesCatalan['ATPI_MES_1']="gener";
literales_arrayLiteralesCatalan['ATPI_MES_2']="febrer";
literales_arrayLiteralesCatalan['ATPI_MES_3']="març";
...
//Literales del fichero AtpiCalendario.js en Inglés
...
//Se añade el array de literales asociados al locale es_ES
...
/***************************************************************************
*    Función encargada de devolver el literal según el locale, éste locale *
*    es introducido desde arquitectura en una variable javascript. En caso *
*    que el locale no esté definido se devolverá el literal en el locale   *
*    es_ES. En el caso de que el locale sea "undefined" o null también se  *
